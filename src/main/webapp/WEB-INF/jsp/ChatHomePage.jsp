...
<body>
	...
	<div id="userJoin" class="container">
		...
		<form id="userJoinForm" name="userJoinForm">
			...
			<div class="form-group">
				<label for="room">Enter Room:</label> <select id="room" type="text"
					aria-describedby="exampleInputRoom" placeholder="Enter room">
	...
	<div id="chatPage" class="container d-none">
		...
		<form id="messagebox" name="messagebox">
			<div class="form-group">
				<label for="message">Enter Message:</label> <input type="text"
					class="form-control" id="message" aria-describedby="name"
